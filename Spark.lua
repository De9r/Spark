...
--   This Is The Spark hannel @JJ8JJJ8 .   --
--                - Spark-                 --
--        -- https://t.me/JJ8JJJ8 --         --
------------------------------------------------ 
...
ControllerAll = false
local ListSudos ={Sudo_Id,1160471152}  
...
MsgText = 'شهلتفاعل استمر' 
elseif tonumber(Message) < 7000 then 
MsgText = 'دكافي شكد تحجي' 
elseif tonumber(Message) < 9500 then 
MsgText = 'تاجر راس التلي' 
...
{
{text = '❲ Fk ❳', url = "https://t.me/JJ8SPARK"},
},
}
local msg_id = msg.id/2097152/0.5 
...
return LuaTele.sendText(msg_chat_id,msg_id,'احترم لك',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'دزلياه خاص 😂😢',"md",false, false, false, false, reply_markup)
end

if text == 'تعالي خاصاااااتا' or text == 'خاصااااااتا' then
if not Redis:get(TheSpark.."Spark:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
local reply_markup = LuaTele.replyMarkup{
...
return LuaTele.sendText(msg_chat_id,msg_id,'وانا هم 🙈❗️',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'بعد لاتجي😂',"md",false, false, false, false, reply_markup)
end

if text == 'عوائلتاةىغان' or text == 'صايره عوائوواال' then
if not Redis:get(TheSpark.."Spark:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
local reply_markup = LuaTele.replyMarkup{
...
return LuaTele.sendText(msg_chat_id,msg_id,'*شـغال🤓️*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'تفضل حبيبي',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'كلخرة',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'لااا',"md",false, false, false, false, reply_markup)
end
if text == 'تحديث' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
...
if text == "تفعيل النداء التلقائي"  then
if not msg.Originators then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*≭︰هذا الامر يخص ‹ "..Controller_Num(5).." ›* ","md",true)  
end
Redis:set(TheSpark.."Spark:"..msg.chat_id,true)  
Redis:setex(TheSpark.."Spark:time:" .. msg.chat_id, 300, true) 
return LuaTele.sendText(msg_chat_id,msg_id,"*≭︰تم تفعيل امر النداء التلقائي*","md",true )
end 
if text == "تعطيل النداء التلقائي"  then
if not msg.Originators then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*≭︰هذا الامر يخص ‹ "..Controller_Num(5).." ›* ","md",true)  
end
Redis:del(TheSpark.."Spark:"..msg.chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"*≭︰تم تعطيل امر النداء التلقائي*","md",true )
end   
if Redis:get(TheSpark.."Spark:"..msg.chat_id) then
local Ndatime = Redis:ttl(TheSpark.."Spark:time:" .. msg.chat_id) 
print(Ndatime)
...
if tonumber(user1) == tonumber(TheSpark) then
local NumRand1 = math.random(1, #List_Members); 
...
Redis:setex(TheSpark.."Spark:time:" .. msg.chat_id, 300, true) 
return LuaTele.sendText(msg.chat_id,0,listTow,"md",true)  
end
end
...
reply_markup = {
inline_keyboard ={
{{text ="❲ Dev  .  ❳", url= "https://t.me/jj8jjj8"}},
}
},
},
}
...
Redis:set(TheSpark..key.."hms",hms)
local us = LuaTele.getUser(TheSpark)
...
reply_markup = {
inline_keyboard ={
{{text ="فتح الهمسه  ", callback_data = TheSpark.."hmsaa"..data.sender_user_id.."/"..key}},
}
},
},
}
...
"لو خيروك |  بين مسح شعرك بسائل غسيل الأطباق وبين استخدام كريم الأساس لغسيل الأطباق؟ ",
...
"لو خيروك |  بين مسح الأطباق كل يوم وبين تحضير الطعام؟ ",
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(TheSpark.."Spark:Name:Bot") or "سبارك")..
...
{
{text = 'مسح المجموعات ⌔',type = 'text'},{text = 'مسح المشتركين ⌔', type = 'text'},
},
{
