...
return {
Lock     = '[Frank](https://t.me/cn_world)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[Frank](https://t.me/cn_world)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[Frank](https://t.me/cn_world)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[Frank](https://t.me/cn_world)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[Frank](https://t.me/cn_world)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[Frank](https://t.me/cn_world)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
{
{text = 'Frank ⁦', url='https://t.me/cn_world'},
},
}
}
...
download('https://raw.githubusercontent.com/De9r/Sparke/main/Spark.lua','Spark.lua')
...
{{text =news,url = "https://t.me/cn_world"}, },}}
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/cn_world"}
},
{
{text = '❲ Frank ❳', url = "https://t.me/cn_world"},
},
...
data = {
{
{text = 'Channel Source ،', url = 't.me/cn_world'}, 
},
{
{text = 'Annotations Source', url = 't.me/jj8jjj8'}, 
},
{
{text = 'Communication Source', url = 't.me/jj8jjjjbot'}, 
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,'اسف اخي ماخليك بحلكي 😀',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'ديلا هو انت منو يحبك 😃🤣',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*وانا هم 🙊🙈*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'وعد توكف واني لا🤓 ️*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'وياك المدير هنا كول',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'انت انجب',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'️️طبعا يحلو/ة😉',"md",false, false, false, false, reply_markup)
end
if text == 'تحديث' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
...
"نعم تفضل",
"وياك فرانك كول",
"ها عيونه ل كول "..NamesBot,
'يمعود والله نعسان عوفني'
}
...
Redis:incrby(TheSpark.."Spark:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف فلوس (%d+)$"))  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم اضافه له { "..text:match("^اضف فلوس (%d+)$").." } من الدنانير").Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id, "᥀︙عدد ديناراتك التي ربحتها *← "..Num.." *","md",true)  
end
end
...
data = {
{
{text = '᥀ السورس .', url = 't.me/cn_world'},{text = '᥀ لتنصيب بوت .', url = 't.me/jj8jjj8'}, 
},
{
...
return LuaTele.sendText(ChatId,Msg_id,'*᥀︙ لا توجد صوره في حسابك*',"md",true) 
end
end
end
...
MahibesText = '*᥀︙الف مبروك حظك حلو اليوم ربحت 1 دينار\n᥀︙فزت ويانه وطلعت المحيبس بل عظمه رقم {'..NumMahibes..'}*'
else
