----------------------------------------------
-- This Source Was Developed By (Frank) @JJ8JJJ8.--
--   This Is Channel @f3ankbot .   --
--                - Frank-                 --
--        -- https://t.me/f3ankbot --         --
------------------------------------------------ 
...
local TheFrank = io.open("TheFrank", 'w')
TheFrank:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 Frank.lua
done
]])
TheFrank:close()
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S TheFrank -X kill
screen -S TheFrank ./TheFrank
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x TheFrank;chmod +x Run;./Run')
end
...
TheFrank = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..TheFrank)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=TheFrank,token=Token}
function var(value)  
...
Status = 0
DevelopersQ = Redis:sismember(TheFrank.."Frank:DevelopersQ:Groups",UserId) 
...
Status = 0
Developers = Redis:sismember(TheFrank.."Frank:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(TheFrank.."Frank:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(TheFrank.."Frank:TheBasics:Group"..ChatId,UserId)
TheBasicsQ = Redis:sismember(TheFrank.."Frank:TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(TheFrank.."Frank:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(TheFrank.."Frank:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(TheFrank.."Frank:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(TheFrank.."Frank:Distinguished:Group"..ChatId,UserId)
...
Status = Redis:get(TheFrank.."Frank:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = Redis:get(TheFrank.."Frank:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(TheFrank.."Frank:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(TheFrank.."Frank:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(TheFrank.."Frank:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(TheFrank.."Frank:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(TheFrank.."Frank:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(TheFrank.."Frank:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(TheFrank.."Frank:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(TheFrank.."Frank:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(TheFrank.."Frank:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(TheFrank.."Frank:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(TheFrank.."Frank:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(TheFrank.."Frank:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(TheFrank.."Frank:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(TheFrank.."Frank:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(TheFrank.."Frank:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(TheFrank.."Frank:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(TheFrank.."Frank:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(TheFrank.."Frank:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(TheFrank.."Frank:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(TheFrank.."Frank:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(TheFrank.."Frank:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(TheFrank.."Frank:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(TheFrank.."Frank:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(TheFrank.."Frank:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(TheFrank.."Frank:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(TheFrank.."Frank:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(TheFrank.."Frank:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(TheFrank.."Frank:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(TheFrank.."Frank:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(TheFrank.."Frank:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(TheFrank.."Frank:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(TheFrank.."Frank:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(TheFrank.."Frank:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(TheFrank.."Frank:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(TheFrank.."Frank:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(TheFrank.."Frank:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(TheFrank.."Frank:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(TheFrank.."Frank:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(TheFrank.."Frank:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(TheFrank.."Frank:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(TheFrank.."Frank:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(TheFrank.."Frank:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(TheFrank.."Frank:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(TheFrank.."Frank:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(TheFrank.."Frank:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(TheFrank.."Frank:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(TheFrank.."Frank:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(TheFrank.."Frank:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(TheFrank.."Frank:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(TheFrank.."Frank:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(TheFrank.."Frank:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(TheFrank.."Frank:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(TheFrank.."Frank:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(TheFrank.."Frank:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(TheFrank.."Frank:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(TheFrank.."Frank:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(TheFrank.."Frank:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(TheFrank.."Frank:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(TheFrank.."Frank:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(TheFrank.."Frank:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(TheFrank.."Frank:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(TheFrank.."Frank:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(TheFrank.."Frank:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(TheFrank.."Frank:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(TheFrank.."Frank:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(TheFrank.."Frank:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(TheFrank.."Frank:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(TheFrank.."Frank:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(TheFrank.."Frank:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(TheFrank.."Frank:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(TheFrank.."Frank:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(TheFrank.."Frank:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(TheFrank.."Frank:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(TheFrank.."Frank:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(TheFrank.."Frank:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(TheFrank.."Frank:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(TheFrank.."Frank:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(TheFrank.."Frank:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(TheFrank.."Frank:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(TheFrank.."Frank:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(TheFrank.."Frank:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(TheFrank.."Frank:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(TheFrank.."Frank:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(TheFrank.."Frank:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(TheFrank.."Frank:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(TheFrank.."Frank:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(TheFrank.."Frank:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(TheFrank.."Frank:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
MsgText = 'عوف الجواهر وتفاعل بزودك' 
elseif tonumber(Message) < 4500 then 
MsgText = 'متفاعل طلقة' 
elseif tonumber(Message) < 5500 then 
MsgText = 'نايم بالكروب' 
elseif tonumber(Message) < 7000 then 
MsgText = 'دروح شوف حياتك كاضيها تفاعل' 
elseif tonumber(Message) < 9500 then 
MsgText = 'دروح شوف حياتك كاضيها تفاعل' 
elseif tonumber(Message) < 10000000000 then 
MsgText = 'تاج راس التلي'  
end 
return MsgText 
end
...
return{
BanAll = Redis:sismember(TheFrank.."Frank:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(TheFrank.."Frank:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(TheFrank.."Frank:SilentGroup:Group"..ChatId,UserId)
}
end
...
return {
Lock     = '[Frank](https://t.me/f3ankbot)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[Frank](https://t.me/f3ankbot)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[Frank](https://t.me/f3ankbot)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[Frank](https://t.me/f3ankbot)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[Frank](https://t.me/f3ankbot)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[Frank](https://t.me/f3ankbot)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,TheFrank).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(TheFrank..'Frank:Channel:Join')
if Channel then
...
if tonumber(msg.sender.user_id) == tonumber(TheFrank) then
...
elseif Redis:sismember(TheFrank.."Frank:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(TheFrank.."Frank:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TheFrank.."Frank:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(TheFrank.."Frank:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(TheFrank.."Frank:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TheFrank.."Frank:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TheFrank.."Frank:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(TheFrank.."Frank:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TheFrank.."Frank:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(TheFrank.."Frank:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TheFrank.."Frank:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(TheFrank.."Frank:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TheFrank.."Frank:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(TheFrank.."Frank:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TheFrank.."Frank:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(TheFrank) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TheFrank.."Frank:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(TheFrank.."Frank:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheFrank.."Frank:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(TheFrank.."Frank:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(TheFrank.."Frank:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(TheFrank) then
return false
end
local floods = Redis:hget(TheFrank.."Frank:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(TheFrank.."Frank:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(TheFrank.."Frank:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(TheFrank.."Frank:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(TheFrank.."Frank:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(TheFrank.."Frank:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(TheFrank.."Frank:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(TheFrank.."Frank:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(TheFrank.."Frank:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(TheFrank.."Frank:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheFrank.."Frank:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheFrank.."Frank:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheFrank.."Frank:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(TheFrank.."Frank:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(TheFrank.."Frank:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(TheFrank.."Frank:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(TheFrank.."Frank:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(TheFrank.."Frank:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(TheFrank.."Frank:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheFrank.."Frank:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(TheFrank.."Frank:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TheFrank.."Frank:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TheFrank.."Frank:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(TheFrank.."Frank:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(TheFrank.."Frank:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(TheFrank.."Frank:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(TheFrank.."Frank:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(TheFrank.."Frank:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(TheFrank.."Frank:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(TheFrank.."Frank:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(TheFrank.."Frank:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(TheFrank.."Frank:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(TheFrank.."Frank:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(TheFrank.."Frank:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(TheFrank.."Frank:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(TheFrank.."Frank:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(TheFrank.."Frank:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(TheFrank.."Frank:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(TheFrank.."Frank:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(TheFrank.."Frank:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(TheFrank..'Frank:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(TheFrank.."Frank:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(TheFrank.."Frank:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(TheFrank.."Frank:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(TheFrank.."Frank:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(TheFrank.."Frank:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(TheFrank.."Frank:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(TheFrank.."Frank:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(TheFrank.."Frank:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(TheFrank..'Frank:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(TheFrank..'Frank:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(TheFrank.."Frank:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(TheFrank.."Frank:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(TheFrank.."Frank:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(TheFrank..'Frank:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(TheFrank..'Frank:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(TheFrank.."Frank:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(TheFrank.."Frank:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(TheFrank.."Frank:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(TheFrank.."Frank:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(TheFrank.."Frank:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(TheFrank.."Frank:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(TheFrank.."Frank:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(TheFrank.."Frank:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(TheFrank..'Frank:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(TheFrank.."Frank:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(TheFrank.."Frank:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(TheFrank.."Frank:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(TheFrank.."Frank:Command:List:Group"..msg_chat_id,text)
...
Redis:del(TheFrank.."Frank:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(TheFrank.."Frank:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(TheFrank.."Frank:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(TheFrank.."Frank:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(TheFrank.."Frank:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(TheFrank.."Frank:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(TheFrank.."Frank:Command:Reids:Group:New"..msg_chat_id)
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(TheFrank.."Frank:Command:List:Group"..msg_chat_id,text)
Redis:del(TheFrank.."Frank:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(TheFrank.."Frank:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(TheFrank.."Frank:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(TheFrank.."Frank:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(TheFrank.."Frank:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(TheFrank.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheFrank.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(TheFrank.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(TheFrank.."Frank:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(TheFrank.."Frank:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheFrank.."Frank:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(TheFrank.."Frank:Group:Rules" .. msg_chat_id,text) 
Redis:del(TheFrank.."Frank:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(TheFrank.."Frank:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheFrank.."Frank:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(TheFrank.."Frank:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(TheFrank.."Frank:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheFrank.."Frank:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheFrank.."Frank:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheFrank.."Frank:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheFrank.."Frank:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(TheFrank.."Frank:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheFrank.."Frank:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(TheFrank.."Frank:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(TheFrank.."Frank:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(TheFrank.."Frank:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(TheFrank.."Frank:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ رد للمدير بنجاح \n᥀︙ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(TheFrank.."Frank:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheFrank.."Frank:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(TheFrank.."Frank:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(TheFrank.."Frank:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheFrank.."Frank:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheFrank.."Frank:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheFrank.."Frank:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(TheFrank.."Frank:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(TheFrank.."Frank:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(TheFrank.."Frank:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(TheFrank.."Frank:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheFrank.."Frank:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(TheFrank.."Frank:List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = 'Frank ⁦', url='https://t.me/f3ankbot'}
},
)
)
...
if text and text:match("^(.*)$") then
if Redis:get(TheFrank.."Frank:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(TheFrank.."Frank:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheFrank.."Frank:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheFrank.."Frank:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheFrank.."Frank:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(TheFrank.."Frank:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheFrank.."Frank:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheFrank.."Frank:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(TheFrank.."Frank:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(TheFrank.."Frank:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(TheFrank.."Frank:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(TheFrank.."Frank:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(TheFrank.."Frank:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(TheFrank.."Frank:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(TheFrank.."Frank:Add:Rd:Sudo:Video"..text)
local document = Redis:get(TheFrank.."Frank:Add:Rd:Sudo:File"..text)
local audio = Redis:get(TheFrank.."Frank:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(TheFrank.."Frank:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheFrank..'Frank:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(TheFrank..'Frank:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(TheFrank.."Frank:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(TheFrank.."Frank:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(TheFrank.."Frank:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(TheFrank.."Frank:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(TheFrank.."Frank:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(TheFrank.."Frank:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(TheFrank.."Frank:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(TheFrank.."Frank:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(TheFrank.."Frank:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(TheFrank.."Frank:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheFrank..'Frank:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TheFrank.."Frank:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(TheFrank.."Frank:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheFrank.."Frank:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheFrank.."Frank:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheFrank.."Frank:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(TheFrank.."Frank:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheFrank.."Frank:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(TheFrank.."Frank:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheFrank.."Frank:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(TheFrank.."Frank:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(TheFrank.."Frank:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(TheFrank.."Frank:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(TheFrank.."Frank:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheFrank.."Frank:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(TheFrank.."Frank:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(TheFrank.."Frank:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TheFrank.."Frank:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(TheFrank..'Frank:'..v..text)
end
Redis:del(TheFrank.."Frank:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheFrank.."Frank:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(TheFrank.."Frank:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheFrank.."Frank:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheFrank.."Frank:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(TheFrank.."Frank:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(TheFrank.."Frank:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(TheFrank.."Frank:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(TheFrank.."Frank:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(TheFrank.."Frank:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(TheFrank.."Frank:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(TheFrank.."Frank:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(TheFrank.."Frank:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(TheFrank.."Frank:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheFrank.."Frank:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheFrank.."Frank:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(TheFrank..'Frank:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheFrank.."Frank:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheFrank.."Frank:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheFrank.."Frank:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheFrank.."Frank:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheFrank.."Frank:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheFrank.."Frank:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheFrank.."Frank:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(TheFrank..'Frank:GetTexting:DevTheFrank'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(TheFrank..'Frank:GetTexting:DevTheFrank'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم الغاء حفظ كليشة المطور')
end
Redis:set(TheFrank..'Frank:Texting:DevTheFrank',text)
Redis:del(TheFrank..'Frank:GetTexting:DevTheFrank'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم حفظ كليشة المطور')
end
if Redis:get(TheFrank.."Frank:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ᥀︙ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(TheFrank.."Frank:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheFrank.."Frank:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheFrank.."Frank:Set:Id:Groups"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ᥀︙ تم تعين الايدي عام',"md",true)  
end
if Redis:get(TheFrank.."Frank:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء امر تعين الايدي","md",true)  
Redis:del(TheFrank.."Frank:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheFrank.."Frank:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheFrank.."Frank:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:get(TheFrank.."Frank:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheFrank.."Frank:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(TheFrank.."Frank:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(TheFrank.."Frank:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "᥀︙ تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(TheFrank.."Frank:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheFrank.."Frank:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(TheFrank.."Frank:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(TheFrank.."Frank:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "᥀︙ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(TheFrank.."Frank:Game:Smile"..msg.chat_id) then
if text == Redis:get(TheFrank.."Frank:Game:Smile"..msg.chat_id) then
Redis:incrby(TheFrank.."Frank:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheFrank.."Frank:Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - سمايل او سمايلات","md",true)  
end
end 
if Redis:get(TheFrank.."Frank:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(TheFrank.."Frank:Game:Monotonous"..msg.chat_id) then
Redis:del(TheFrank.."Frank:Game:Monotonous"..msg.chat_id)
Redis:incrby(TheFrank.."Frank:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - الاسرع او ترتيب","md",true)  

end
end 
if Redis:get(TheFrank.."Frank:Game:Riddles"..msg.chat_id) then
if text == Redis:get(TheFrank.."Frank:Game:Riddles"..msg.chat_id) then
Redis:incrby(TheFrank.."Frank:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheFrank.."Frank:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - حزوره","md",true)  

end
end
if Redis:get(TheFrank.."Frank:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(TheFrank.."Frank:Game:Meaningof"..msg.chat_id) then
Redis:incrby(TheFrank.."Frank:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheFrank.."Frank:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - معاني","md",true)  

end
end
if Redis:get(TheFrank.."Frank:Game:Reflection"..msg.chat_id) then
if text == Redis:get(TheFrank.."Frank:Game:Reflection"..msg.chat_id) then
Redis:incrby(TheFrank.."Frank:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheFrank.."Frank:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - العكس","md",true)  

end
end
if Redis:get(TheFrank.."Frank:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(TheFrank.."Frank:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TheFrank.."Frank:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheFrank.."Frank:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TheFrank.."Frank:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TheFrank.."Frank:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TheFrank.."Frank:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TheFrank.."Frank:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheFrank.."Frank:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TheFrank.."Frank:Game:Difference"..msg.chat_id) then
if text == Redis:get(TheFrank.."Frank:Game:Difference"..msg.chat_id) then 
Redis:del(TheFrank.."Frank:Game:Difference"..msg.chat_id)
Redis:incrby(TheFrank.."Frank:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TheFrank.."Frank:Game:Example"..msg.chat_id) then
if text == Redis:get(TheFrank.."Frank:Game:Example"..msg.chat_id) then 
Redis:del(TheFrank.."Frank:Game:Example"..msg.chat_id)
Redis:incrby(TheFrank.."Frank:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheFrank..'Frank:Channel:Join')}, },}}
...
if tonumber(TheFrank) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(TheFrank..'Frank:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(TheFrank.."Frank:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TheFrank.."Frank:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TheFrank.."Frank:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TheFrank.."Frank:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TheFrank.."Frank:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TheFrank.."Frank:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(TheFrank) then 
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(TheFrank.."Frank:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TheFrank.."Frank:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TheFrank.."Frank:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TheFrank.."Frank:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TheFrank.."Frank:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(TheFrank..'Frank:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(TheFrank..'Frank:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,TheFrank).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(TheFrank..'Frank:Channel:Join',ChannelUser) 
...
Redis:set(TheFrank..'Frank:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheFrank..'Frank:Channel:Join')
...
os.execute('rm -rf Frank.lua')
download('https://raw.githubusercontent.com/De9r/Frank/main/Frank.lua','Frank.lua')
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(TheFrank..'Frank:Channel:Join:Name')..'', url = 't.me/'..Redis:get(TheFrank..'Frank:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'\n• يجب عليك الاشتراك في القناه',"md",false, false, false, false, reply_markup)
end
Redis:del(TheFrank.."Frank:SendBcBot") 
...
Redis:set(TheFrank.."Frank:SendBcBot",true) 
...
Redis:del(TheFrank.."Frank:LeftBot") 
...
Redis:set(TheFrank.."Frank:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," ᥀︙ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(TheFrank.."Frank:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(TheFrank.."Frank:AddSudosNew"..msg_chat_id)
...
Redis:set(TheFrank.."Frank:AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(TheFrank..'Frank:ChekBotAdd')  
local UsersBot = Redis:smembers(TheFrank..'Frank:Num:User:Pv')  
local Get_Json = '{"BotId": '..TheFrank..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(TheFrank.."Frank:TheBasics:Group"..v)
local Constructor = Redis:smembers(TheFrank.."Frank:Originators:Group"..v)
local Manager = Redis:smembers(TheFrank.."Frank:Managers:Group"..v)
local Admin = Redis:smembers(TheFrank.."Frank:Addictive:Group"..v)
local Vips = Redis:smembers(TheFrank.."Frank:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(TheFrank.."Frank:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(TheFrank.."Frank:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(TheFrank.."Frank:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(TheFrank.."Frank:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(TheFrank.."Frank:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(TheFrank.."Frank:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(TheFrank.."Frank:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(TheFrank.."Frank:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(TheFrank.."Frank:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(TheFrank.."Frank:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(TheFrank.."Frank:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(TheFrank.."Frank:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(TheFrank.."Frank:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(TheFrank.."Frank:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(TheFrank.."Frank:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(TheFrank.."Frank:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(TheFrank.."Frank:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(TheFrank.."Frank:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(TheFrank.."Frank:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(TheFrank.."Frank:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(TheFrank.."Frank:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(TheFrank.."Frank:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(TheFrank.."Frank:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(TheFrank.."Frank:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(TheFrank.."Frank:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(TheFrank.."Frank:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(TheFrank.."Frank:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(TheFrank.."Frank:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(TheFrank.."Frank:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(TheFrank..'Frank:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*᥀︙عدد احصائيات البوت الكامله \n— — — — — — — — —\n᥀︙عدد المجموعات : '..(Redis:scard(TheFrank..'Frank:ChekBotAdd') or 0)..'\n᥀︙عدد المشتركين : '..(Redis:scard(TheFrank..'Frank:Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(TheFrank.."Frank:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheFrank..'Frank:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TheFrank..'Frank:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(TheFrank.."Frank:ChekBotAdd",msg_chat_id)
Redis:set(TheFrank.."Frank:Status:Id"..msg_chat_id,true) ;Redis:set(TheFrank.."Frank:Status:Reply"..msg_chat_id,true) ;Redis:set(TheFrank.."Frank:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TheFrank.."Frank:Status:BanId"..msg_chat_id,true) ;Redis:set(TheFrank.."Frank:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(TheFrank.."Frank:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TheFrank.."Frank:ChekBotAdd",msg_chat_id) then
...
Redis:srem(TheFrank.."Frank:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(TheFrank.."Frank:ChekBotAdd",msg_chat_id) then
Redis:incr(TheFrank..'Frank:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
if text == "ايدي" and msg.reply_to_message_id == 0 then
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheFrank..'Frank:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n᥀︙عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end 
if not Redis:get(TheFrank.."Frank:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(TheFrank..'Frank:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(TheFrank..'Frank:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(TheFrank.."Frank:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(TheFrank.."Frank:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
local Texting = {'.',".",".",".",".",}
...
Get_Is_Id = Redis:get(TheFrank.."Frank:Set:Id:Group"..msg_chat_id)
if Redis:get(TheFrank.."Frank:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(TheFrank..'Frank:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(TheFrank..'Frank:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*᥀︙ايديه : '..UserId..
...
local TotalMsg = Redis:get(TheFrank..'Frank:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(TheFrank..'Frank:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*᥀︙ايديه : '..UserId..
'\n᥀︙معرفه : @'..UserName..
...
{
{text = ' ميسح الاساسين ', data =msg.sender.user_id..'/'.. 'TheBasics'}
},
{
...
Redis:set(TheFrank.."Frank:Set:Id:Group"..msg.chat_id,Text_Rand)
...
{{text =news,url = "https://t.me/f3ankbot"}, },}}
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,TheFrank).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,TheFrank).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(TheFrank.."Frank:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"* ᥀︙تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheFrank.."Frank:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheFrank.."Frank:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheFrank.."Frank:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheFrank.."Frank:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheFrank.."Frank:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheFrank.."Frank:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheFrank.."Frank:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheFrank.."Frank:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheFrank.."Frank:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheFrank.."Frank:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheFrank.."Frank:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheFrank.."Frank:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheFrank.."Frank:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheFrank.."Frank:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheFrank.."Frank:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheFrank.."Frank:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheFrank.."Frank:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheFrank.."Frank:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheFrank.."Frank:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheFrank.."Frank:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheFrank.."Frank:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheFrank.."Frank:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"* ᥀︙تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(TheFrank.."Frank:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:Developers:Groups",UserId) 
...
if not Redis:sismember(TheFrank.."Frank:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheFrank.."Frank:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheFrank.."Frank:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheFrank.."Frank:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheFrank.."Frank:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheFrank.."Frank:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheFrank.."Frank:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(TheFrank.."Frank:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(TheFrank.."Frank:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheFrank.."Frank:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheFrank.."Frank:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheFrank.."Frank:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheFrank.."Frank:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ᥀︙تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(TheFrank.."Frank:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheFrank.."Frank:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheFrank.."Frank:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheFrank.."Frank:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheFrank.."Frank:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheFrank.."Frank:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheFrank.."Frank:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheFrank.."Frank:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheFrank.."Frank:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheFrank.."Frank:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheFrank.."Frank:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheFrank.."Frank:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheFrank.."Frank:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ᥀︙تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(TheFrank.."Frank:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:Developers:Groups",UserId) 
...
if Redis:sismember(TheFrank.."Frank:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheFrank.."Frank:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheFrank.."Frank:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheFrank.."Frank:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheFrank.."Frank:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheFrank.."Frank:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(TheFrank.."Frank:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(TheFrank.."Frank:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheFrank.."Frank:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheFrank.."Frank:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(TheFrank.."Frank:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheFrank.."Frank:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(TheFrank.."Frank:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(TheFrank.."Frank:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*᥀︙قائمه مطورين البوت \n — — — — — — — — —*\n'
...
local Info_Members = Redis:smembers(TheFrank.."Frank:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheFrank.."Frank:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheFrank.."Frank:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheFrank.."Frank:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheFrank.."Frank:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheFrank.."Frank:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheFrank.."Frank:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheFrank.."Frank:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheFrank.."Frank:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(TheFrank.."Frank:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(TheFrank.."Frank:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(TheFrank.."Frank:Status:Id"..msg_chat_id,true) 
...
Redis:set(TheFrank.."Frank:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(TheFrank.."Frank:Status:Reply"..msg_chat_id,true) 
...
Redis:set(TheFrank.."Frank:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(TheFrank.."Frank:Status:BanId"..msg_chat_id,true) 
...
Redis:set(TheFrank.."Frank:BotFree",true) 
...
Redis:set(TheFrank.."Frank:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(TheFrank.."Frank1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TheFrank.."Frank1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheFrank.."Frank1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheFrank.."Frank1:List:Rd:Sudo"..msg.chat_id, text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TheFrank.."Frank1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TheFrank..'Frank1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(TheFrank..'Frank1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(TheFrank..'Frank1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(TheFrank.."Frank1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheFrank.."Frank1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(TheFrank.."Frank1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(TheFrank.."Frank1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(TheFrank.."Frank1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(TheFrank.."Frank1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(TheFrank.."Frank1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(TheFrank.."Frank1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheFrank.."Frank1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheFrank.."Frank1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheFrank.."Frank1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheFrank.."Frank1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheFrank.."Frank1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheFrank.."Frank1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheFrank.."Frank1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheFrank.."Frank1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheFrank.."Frank1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheFrank.."Frank1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheFrank.."Frank1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheFrank.."Frank1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheFrank.."Frank1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(TheFrank.."Frank1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(TheFrank.."Frank1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(TheFrank.."Frank1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(TheFrank.."Frank11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(TheFrank.."Frank11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheFrank.."Frank11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheFrank.."Frank11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(TheFrank.."Frank11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(TheFrank..'Frank11:Add:Rd:Sudo:Text'..text)
Redis:del(TheFrank..'Frank11:Add:Rd:Sudo:Text1'..text)
Redis:del(TheFrank..'Frank11:Add:Rd:Sudo:Text2'..text)
Redis:del(TheFrank.."Frank11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheFrank.."Frank11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(TheFrank.."Frank11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(TheFrank.."Frank11:Add:Rd:Sudo:Text"..v) 
Redis:del(TheFrank.."Frank11:Add:Rd:Sudo:Text1"..v) 
Redis:del(TheFrank.."Frank11:Add:Rd:Sudo:Text2"..v)   
Redis:del(TheFrank.."Frank11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(TheFrank.."Frank11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(TheFrank.."Frank11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheFrank.."Frank11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheFrank.."Frank11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheFrank.."Frank11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheFrank.."Frank11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(TheFrank.."Frank11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheFrank.."Frank11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheFrank.."Frank11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheFrank.."Frank11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(TheFrank.."Frank11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheFrank.."Frank11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheFrank.."Frank11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheFrank.."Frank11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(TheFrank.."Frank11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(TheFrank.."Frank11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(TheFrank.."Frank11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(TheFrank.."Frank:allM"..msg.chat_id, msg.id)
if Redis:get(TheFrank.."Frank:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(TheFrank.."Frank:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(TheFrank.."Frank:allM"..msg.chat_id)
...
Redis:del(TheFrank.."Frank:allM"..msg.chat_id)
end
end
end

if text == ("امسح تلقائي لك") then  
if not msg.TheBasics then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙هاذا الامر يخص { '..Controller_Num(4)..' }* ',"md",true)  
end
local list = Redis:smembers(TheFrank.."Frank:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(TheFrank.."Frank:allM"..msg.chat_id)  
...
Redis:del(TheFrank.."Frank:Status:Del:Media"..msg.chat_id)
...
Redis:set(TheFrank.."Frank:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(TheFrank.."Frank:Status:yt"..msg.chat_id)
...
Redis:set(TheFrank.."Frank:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(TheFrank.."Frank:Status:yt"..msg.chat_id) then
local Ttext = text:match('^بحث (.*)$') 
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
local httpsCurl = "https://laganty.ml/.rest/fbdl/fbdl.php?token="..Token.."&msg="..MSGID.."&Text="..URL.escape(Ttext).."&chat_id="..msg_chat_id.."&user="..msg.sender.user_id
...
if TextMsg == 'الرابط' then
Redis:del(TheFrank.."Frank:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(TheFrank.."Frank:Status:Welcome"..msg_chat_id) 
...
Redis:del(TheFrank.."Frank:Status:Id"..msg_chat_id) 
...
Redis:del(TheFrank.."Frank:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(TheFrank.."Frank:Status:Reply"..msg_chat_id) 
...
Redis:del(TheFrank.."Frank:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(TheFrank.."Frank:Status:BanId"..msg_chat_id) 
...
Redis:del(TheFrank.."Frank:BotFree") 
...
Redis:del(TheFrank.."Frank:TwaslBot") 
...
if Redis:sismember(TheFrank.."Frank:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheFrank.."Frank:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(TheFrank.."Frank:BanAll:Groups",UserId_Info.id) 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/f3ankbot'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ᥀︙ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
if Redis:sismember(TheFrank.."Frank:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheFrank.."Frank:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheFrank.."Frank:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(TheFrank.."Frank:ktmAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheFrank.."Frank:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TheFrank.."Frank:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TheFrank.."Frank:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(TheFrank.."Frank:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheFrank.."Frank:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TheFrank.."Frank:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(TheFrank.."Frank:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheFrank.."Frank:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheFrank.."Frank:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheFrank.."Frank:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheFrank.."Frank:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheFrank.."Frank:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheFrank.."Frank:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheFrank.."Frank:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheFrank.."Frank:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheFrank.."Frank:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheFrank.."Frank:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(TheFrank.."Frank:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheFrank.."Frank:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheFrank.."Frank:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheFrank.."Frank:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheFrank.."Frank:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheFrank.."Frank:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheFrank.."Frank:BanGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TheFrank.."Frank:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(TheFrank.."Frank:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheFrank.."Frank:SilentGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TheFrank.."Frank:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(TheFrank.."Frank:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheFrank.."Frank:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if text == "اطردني" or text == "ااطردني" then
if not Redis:get(TheFrank.."Frank:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheFrank.."Frank:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheFrank.."Frank:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if not msg.ControllerBot and not Redis:set(TheFrank.."Frank:LeftBot") then
...
Redis:set(TheFrank.."Frank:Lock:text"..msg_chat_id,true) 
...
Redis:set(TheFrank.."Frank:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(TheFrank.."Frank:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(TheFrank.."Frank:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(TheFrank.."Frank:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(TheFrank.."Frank:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(TheFrank.."Frank:Lock:edit"..msg_chat_id,true) 
...
Redis:set(TheFrank.."Frank:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheFrank..'Frank:'..lock..msg_chat_id,"del")    
end
...
Redis:del(TheFrank.."Frank:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(TheFrank.."Frank:Lock:text"..msg_chat_id)  
...
Redis:del(TheFrank.."Frank:Lock:Join"..msg_chat_id)  
...
Redis:del(TheFrank.."Frank:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(TheFrank.."Frank:Lock:tagservr"..msg_chat_id)  
...
Redis:del(TheFrank.."Frank:lockpin"..msg_chat_id)  
...
Redis:del(TheFrank.."Frank:Lock:edit"..msg_chat_id) 
...
Redis:del(TheFrank.."Frank:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TheFrank..'Frank:'..lock..msg_chat_id)    
end
...
Redis:hset(TheFrank.."Frank:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(TheFrank.."Frank:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(TheFrank.."Frank:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(TheFrank.."Frank:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(TheFrank.."Frank:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(TheFrank.."Frank:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:Link"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Lock:channell"..msg_chat_id,true) 
...
Redis:del(TheFrank.."Lock:channell"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:User:Name"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:hashtak"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:Cmd"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:Photo"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:Video"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:Animation"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:geam"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:Audio"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:vico"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:Sticker"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:forward"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:Document"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:Contact"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:Spam"..msg_chat_id)  
...
Redis:set(TheFrank.."Frank:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(TheFrank.."Frank:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(TheFrank.."Frank:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(TheFrank.."Frank:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(TheFrank.."Frank:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(TheFrank.."Frank:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(TheFrank.."Frank:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(TheFrank.."Frank:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(TheFrank.."Frank:Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
Redis:setex(TheFrank.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(TheFrank.."Frank:Status:Welcome"..msg_chat_id) then
...
Redis:del(TheFrank.."Frank:Welcome:Group"..msg_chat_id) 
...
Redis:setex(TheFrank.."Frank:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(TheFrank.."Frank:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(TheFrank.."Frank:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(TheFrank.."Frank:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheFrank.."Frank:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(TheFrank.."Frank:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TheFrank.."Frank:Filter:Group:"..v..msg_chat_id)  
Redis:srem(TheFrank.."Frank:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TheFrank.."Frank:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(TheFrank..'Frank:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(TheFrank..'Frank:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(TheFrank.."Frank:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TheFrank.."Frank:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(TheFrank.."Frank:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(TheFrank.."Frank:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(TheFrank.."Frank:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(TheFrank.."Frank:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(TheFrank.."Frank:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(TheFrank.."Frank:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(TheFrank.."Frank:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(TheFrank.."Frank:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(TheFrank.."Frank:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(TheFrank.."Frank:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(TheFrank.."Frank:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(TheFrank.."Frank:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(TheFrank.."Frank:Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '- قناة السورس', url = 't.me/f3ankbot'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(TheFrank.."Frank:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheFrank.."Frank:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(TheFrank.."Frank:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(TheFrank.."Frank:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheFrank.."Frank:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheFrank.."Frank:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(TheFrank.."Frank:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TheFrank.."Frank:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(TheFrank.."Frank:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(TheFrank.."Frank:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TheFrank.."Frank:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TheFrank.."Frank:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(TheFrank..'Frank:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(TheFrank..'Frank:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(TheFrank..'Frank:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد رسائلك هنا *~ '..(Redis:get(TheFrank..'Frank:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد التعديلات هنا *~ '..(Redis:get(TheFrank..'Frank:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد جهاتك المضافه هنا *~ '..(Redis:get(TheFrank.."Frank:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(TheFrank.."Frank:Set:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ᥀︙ ارسل الان النص
 ᥀︙ يمكنك اضافه :
...
if text == 'حذف الايدي العام' or text == 'مسح الايدي العام' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ᥀︙ هاذا الامر يخص 『 '..Controller_Num(1)..' 』* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
Redis:del(TheFrank.."Frank:Set:Id:Groups")
...
Redis:setex(TheFrank.."Frank:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
᥀︙ارسل الان النص
᥀︙يمكنك اضافه :
᥀︙`#username` » اسم المستخدم
...
Redis:del(TheFrank.."Frank:Set:Id:Group"..msg.chat_id)
...
Redis:del(TheFrank.."Frank:DevelopersQ:Groups") 
...
Redis:del(TheFrank.."Frank:Developers:Groups") 
...
Redis:del(TheFrank.."Frank:TheBasicsQ:Group"..msg_chat_id) 
...
Redis:del(TheFrank.."Frank:TheBasics:Group"..msg_chat_id) 
...
Redis:del(TheFrank.."Frank:Originators:Group"..msg_chat_id) 
...
Redis:del(TheFrank.."Frank:Managers:Group"..msg_chat_id) 
...
Redis:del(TheFrank.."Frank:Addictive:Group"..msg_chat_id) 
...
Redis:del(TheFrank.."Frank:Distinguished:Group"..msg_chat_id) 
...
Redis:del(TheFrank.."Frank:BanAll:Groups") 
...
Redis:del(TheFrank.."Frank:BanGroup:Group"..msg_chat_id) 
...
Redis:del(TheFrank.."Frank:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(TheFrank.."Frank:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(TheFrank.."Frank:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(TheFrank.."Frank:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(TheFrank.."Frank:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(TheFrank.."Frank:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(TheFrank.."Frank:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(TheFrank.."Frank:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(TheFrank.."Frank:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(TheFrank.."Frank:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(TheFrank.."Frank:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(TheFrank.."Frank:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(TheFrank.."Frank:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(TheFrank.."Frank:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(TheFrank.."Frank:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(TheFrank.."Frank:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(TheFrank.."Frank:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(TheFrank.."Frank:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(TheFrank.."Frank:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ⌔"
elseif Redis:get(TheFrank.."Frank:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(TheFrank.."Frank:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheFrank.."Frank:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheFrank.."Frank:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(TheFrank.."Frank:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TheFrank.."Frank:Add:Rd:Sudo:Gif"..v)   
Redis:del(TheFrank.."Frank:Add:Rd:Sudo:vico"..v)   
Redis:del(TheFrank.."Frank:Add:Rd:Sudo:stekr"..v)     
Redis:del(TheFrank.."Frank:Add:Rd:Sudo:Text"..v)   
Redis:del(TheFrank.."Frank:Add:Rd:Sudo:Photo"..v)
Redis:del(TheFrank.."Frank:Add:Rd:Sudo:Video"..v)
Redis:del(TheFrank.."Frank:Add:Rd:Sudo:File"..v)
Redis:del(TheFrank.."Frank:Add:Rd:Sudo:Audio"..v)
Redis:del(TheFrank.."Frank:Add:Rd:Sudo:video_note"..v)
Redis:del(TheFrank.."Frank:List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \n— — — — — — — — —\n"
for k,v in pairs(list) do
if Redis:get(TheFrank.."Frank:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(TheFrank.."Frank:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(TheFrank.."Frank:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(TheFrank.."Frank:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(TheFrank.."Frank:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(TheFrank.."Frank:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(TheFrank.."Frank:Add:Rd:Sudo:File"..v) then
db = "ملف ⌔"
elseif Redis:get(TheFrank.."Frank:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(TheFrank.."Frank:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheFrank.."Frank:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheFrank.."Frank:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(TheFrank.."Frank:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheFrank.."Frank:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheFrank.."Frank:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheFrank.."Frank:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(TheFrank.."Frank:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheFrank..'Frank:GetTexting:DevTheFrank'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheFrank..'Frank:Texting:DevTheFrank')
...
local UserId_Info = LuaTele.searchPublicChat("JJ8JJJ8")
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/JJ8JJJ8"}
},
{
{text = '❲ سورس فرانك ❳', url = "https://t.me/f3ankbot"},
},
}
local msg_id = msg.id/2097152/0.5 
...
if not Redis:get(TheFrank.."Frank:Status:gamle"..msg_chat_id) then
return false
end
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(TheFrank.."Frank:Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(TheFrank.."Frank:Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
data = {
{
{text = 'Channel Source ،', url = 't.me/f3ankbot'}, 
},
{
{text = 'Annotations Source', url = 't.me/f3ankbot'}, 
},
{
{text = 'Communication Source', url = 't.me/JJ8JJJ8'}, 
},
{
{text = 'Developer Source !', url = 't.me/JJ8JJJ8'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
if not Redis:get(TheFrank.."Frank:Sasa:Jeka"..msg_chat_id) then
...
return LuaTele.sendText(msg_chat_id,msg_id,'شبيك',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'توكل',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'دعوفه شعليك بي',"md",false, false, false, false, reply_markup)
end

if text == 'كلخره' or text == 'كل خره' or text == 'كلخرة' then
if not Redis:get(TheFrank.."Frank:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
local reply_markup = LuaTele.replyMarkup{
...
return LuaTele.sendText(msg_chat_id,msg_id,'هو انت اكبر خرة',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'هسة دعوفه شلطشت 😂🤚',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'امشيك بيها 🌚🤣',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'وينه وينه 🌚😂',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'لطالما كرهت العبيد اسيادها 🐸',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'اموت عليك 🙈❗',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'وين يمعود خلينه متونسين',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'اربط فيشه 🦦🤣',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'كضيت عمري مشتغل ما اوكف',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'تفضل وياك المدير 🚬😎',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'لوما الناس جان عرفت شكلك 😉',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'هو انت اهلك نايحبوك تريدني احبك 🤣',"md",false, false, false, false, reply_markup)
end
if text == 'تحديث' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
...
Redis:setex(TheFrank.."Frank:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheFrank.."Frank:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(TheFrank.."Frank:Name:Bot") or "سبارك") then
local NamesBot = (Redis:get(TheFrank.."Frank:Name:Bot") or "سبارك")
local NameBots = {
"ها شتريد؟",
"موجود كول",
"موجود بس لتصيح",
"أخرتني عندي كروبات احميها كول شرايد",
...
x = x + 1
Redis:srem(TheFrank..'Frank:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,TheFrank)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*᥀︙البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(TheFrank..'Frank:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(TheFrank..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(TheFrank..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(TheFrank..'Frank:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(TheFrank.."Frank:Game:Smile"..msg.chat_id,SM)
...
Redis:set(TheFrank.."Frank:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(TheFrank.."Frank:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(TheFrank.."Frank:Status:Games"..msg.chat_id) then
Redis:del(TheFrank.."Frank:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(TheFrank.."Frank:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(TheFrank.."Frank:Status:Games"..msg.chat_id) then
Redis:del(TheFrank.."Frank:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(TheFrank.."Frank:Game:Reflection"..msg.chat_id,name)
...
Redis:set(TheFrank.."Frank:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(TheFrank.."Frank:Game:Difference"..msg.chat_id,name)
...
Redis:set(TheFrank.."Frank:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(TheFrank.."Frank:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(TheFrank.."Frank:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(TheFrank.."Frank:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(TheFrank.."Frank:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(TheFrank.."Frank:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(TheFrank.."Frank:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..'مم','رفع مميز')
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..'الردود','ردود المدير')
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..'م م','مسح المكتومين')
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(TheFrank.."Frank:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
if text == '/start' then
Redis:sadd(TheFrank..'Frank:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(TheFrank.."Frank:Start:Bot") then
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(TheFrank.."Frank:Name:Bot") or "فرانك")..
...
data = {
{
{text = '᥀ السورس .', url = 't.me/f3ankbot'},{text = '᥀ لتنصيب بوت .', url = 't.me/JJ8JJJ8'}, 
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheFrank.."Frank:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(TheFrank.."Frank:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheFrank.."Frank:Start:Bot") 
...
if not msg.ControllerBot then
if Redis:get(TheFrank.."Frank:TwaslBot") and not Redis:sismember(TheFrank.."Frank:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(TheFrank.."Frank:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(TheFrank.."Frank:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(TheFrank..'Frank:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'᥀︙تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(TheFrank..'Frank:BaN:In:Tuasl',Info_User)  
...
Redis:srem(TheFrank.."Frank:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(TheFrank..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(TheFrank.."Frank:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheFrank.."Frank:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(TheFrank.."Frank:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheFrank.."Frank:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(TheFrank.."Frank:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheFrank.."Frank:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(TheFrank.."Frank:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheFrank.."Frank:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(TheFrank.."Frank:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheFrank.."Frank:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(TheFrank.."Frank:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheFrank.."Frank:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(TheFrank.."Frank:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheFrank.."Frank:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(TheFrank.."Frank:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheFrank.."Frank:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(TheFrank.."Frank:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheFrank.."Frank:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(TheFrank.."Frank:Lock:tagservr"..data.message.chat_id) then
...
if Message_Edit.sender.user_id == TheFrank then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(TheFrank..'Frank:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TheFrank.."Frank:Lock:edit"..data.chat_id) then
...
if tonumber(listYt[1]) == tonumber(IdUser) then
Redis:srem(TheFrank.."Frank:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(TheFrank.."Frank:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:del(TheFrank.."Frank:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(TheFrank.."Frank1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(TheFrank.."Frank:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TheFrank.."Frank:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheFrank.."Frank:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheFrank.."Frank1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheFrank.."Frank:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheFrank.."Frank:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(TheFrank.."Frank:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheFrank.."Frank:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheFrank.."Frank:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheFrank.."Frank:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheFrank.."Frank:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Sasa:Jeka"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFrank.."Frank:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheFrank.."Frank:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheFrank.."Frank:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TheFrank.."Frank:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheFrank..'Frank:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TheFrank.."Frank:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFrank.."Frank:SilentGroup:Group"..ChatId) 
