...
Redis:set(TheSpark.."Lock:channell"..msg_chat_id,true) 
...
Redis:del(TheSpark.."Lock:channell"..msg_chat_id)  
...
Redis:set(TheSpark.."Spark:Get:Reides:Commands:Group"..msg_chat_id..":"..'مم','رفع مميز')
...
Redis:set(TheSpark.."Spark:Get:Reides:Commands:Group"..msg_chat_id..":"..'الردود','ردود المدير')
Redis:set(TheSpark.."Spark:Get:Reides:Commands:Group"..msg_chat_id..":"..'م م','مسح المكتومين')
